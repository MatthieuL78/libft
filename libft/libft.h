...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/11/24 15:35:28 by malu              #+#    #+#             */
/*   Updated: 2018/11/28 18:12:08 by malu             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*ft_memalloc(void *valu, size_t size);
void	*ft_memccpy(void *dest, const void *src, int c, size_t n);
void	*ft_memchr(void *s, int c, size_t n);
int		ft_memcmp(const void *s1, const void *s2, size_t n);
void	*ft_memcpy(void *dest, const void *src, size_t n);
void	*ft_memdel(void *value);
int		ft_strlenlimit(char *str, size_t n);
...
int		ft_streau(char *s1, char *s2);
void	ft_stritr(char *str, void (*f)(char *));
